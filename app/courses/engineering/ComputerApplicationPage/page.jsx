...
export default function MindlerComputerApplicationPage() {
  ...
  // Jammu and Kashmir opportunities with visual data
  const jammuKashmirOpportunities = [
    {
      title: "Government IT Initiatives",
      description: "The Jammu & Kashmir government has launched several IT initiatives including 'Digital J&K' and 'e-Office' to digitize government services.",
      icon: "🏛️",
      growth: 85,
      jobs: 1200,
      salary: "₹4-8 LPA"
    },
    {
      ...
      description: "IT parks in Srinagar and Jammu are being developed to foster the growth of IT companies and startups.",
      icon: "🏢",
      growth: 78,
      jobs: 800,
      salary: "₹3-6 LPA"
    },
    {
      ...
      description: "With tourism being a major industry in J&K, there's growing demand for IT professionals to develop tourism-related applications.",
      icon: "🏔️",
      growth: 92,
      jobs: 950,
      salary: "₹3.5-7 LPA"
    },
    {
      ...
      description: "Various e-governance projects are being implemented to improve service delivery to citizens.",
      icon: "📋",
      growth: 80,
      jobs: 1100,
      salary: "₹4-7.5 LPA"
    },
    {
      ...
      description: "Universities and colleges in J&K are expanding their IT departments, creating teaching and research opportunities.",
      icon: "🎓",
      growth: 65,
      jobs: 600,
      salary: "₹3-5 LPA"
    },
    {
      ...
      description: "Improved internet connectivity has opened up remote work opportunities for J&K residents with national and international companies.",
      icon: "💻",
      growth: 95,
      jobs: 1500,
      salary: "₹5-12 LPA"
    ...
    <div className="font-sans bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-hidden">
            <div className="bg-gradient-to-r from-purple-600 to-indigo-700 p-6 text-white">
              <div className="flex justify-between items-center">
                <h3 className="text-xl font-bold">Compare Computer Application with</h3>
                <button
            ...
            <div className="p-6 overflow-y-auto max-h-[70vh]">
              <div className="space-y-3">
                {[
                  "Computer Application vs Game Development",
                  "Computer Application vs Mechanical Engineering",
                  "Computer Application vs Civil Engineering",
                  "Computer Application vs Electrical Engineering",
      ...
      <div className="flex px-8 py-8 gap-8 max-w-7xl mx-auto">
        ...
        <main className="w-3/4">
          ...
          {/* Enhanced Jammu and Kashmir Opportunities Section */}
          <section className="mb-12 bg-white rounded-xl shadow-lg p-8 border border-gray-100" ref={jammuKashmirRef}>
            ...
            <div className="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex-1">
                  <h4 className="text-lg font-semibold mb-3 text-gray-800">IT Sector Growth in J&K</h4>
                  <p className="text-gray-700 text-sm leading-relaxed mb-4">
                    The IT sector in Jammu and Kashmir is experiencing rapid growth with increasing government support and private investments.
                    The region offers unique opportunities for IT professionals to contribute to its digital transformation.
                  </p>
                </div>
              ...
              <div className="mt-6">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2.5">
                  <div className="bg-gradient-to-r from-blue-500 to-indigo-600 h-2.5 rounded-full" style={{ width: '82%' }}></div>
                </div>
              </div>
            </div>
